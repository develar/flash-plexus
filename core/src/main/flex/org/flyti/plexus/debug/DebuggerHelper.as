...
import org.flyti.plexus.actions.builders.IBuilder;
...
[ExcludeClass]
	public class DebuggerHelper implements IDebuggerHelper
	{
		...
		*                                          Protected methods
		...
		/*-.........................................formatValue..........................................*/
		protected function formatValue(value:Object, loggerProvider:ILoggerProvider):String
		{
	    ...
	    protected function validateSignature(info:LogInfo):void
		{
	        ...
	        {
		        var prop:XMLList = description.method.(@name == info.method);
		...
		protected function actionListStart(event:MateLogEvent):String
		{
			...
			if(info.loggerProvider is Scope)
			{
				...
				if(Object(scope.owner).hasOwnProperty('type'))
				{
					message += "   type=" + getEventType(scope.currentEvent) + "   phase=" + scope.currentEvent.eventPhase + " target=" + scope.currentEvent.target + " currentTarget=" + scope.currentEvent.currentTarget;
				}
