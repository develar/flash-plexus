...
package org.flyti.plexus.testing
{
	...
	{	
	    ...
	    */
		...
		protected function loadData():void 
		{
			...
			{
				startFault(new Fault(error.name, error.message, error.getStackTrace()));
			}
		}
...
//			}
		...
		{
			new AsyncDispatcher(dispatchResult, new Vector.<Function>[result], method.delay * 1000);
		}
		...
		{
			new AsyncDispatcher(dispatchFault, new Vector.<Function>[fault], method.delay * 1000);
		}
