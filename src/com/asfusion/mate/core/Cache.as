...
package com.asfusion.mate.core
{
	...
	public class Cache extends Proxy implements IEventDispatcher, ISmartObject
	{
		 ...
		 */
		protected var chain:Vector.<String>;
		 ...
		 * 
		 */
		public function addKey(chain:Vector.<String>, key:String):void
		{
			this.chain = chain != null ? chain : new Vector.<String>();
			this.chain.push(key);
		}
		...
		public function getValue(scope:IScope, debugCall:Boolean=false):Object
		{
			...
			if(instance && chain != null)
			{
				...
				catch(error:ReferenceError)
				{
					...
					{
						var stringChain:String = chain != null ? chain.join(".") : null;
