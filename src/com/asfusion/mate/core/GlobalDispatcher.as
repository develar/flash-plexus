...
public class GlobalDispatcher implements IEventDispatcher
{
	 ...
	 */
//	private function get applicationDispatcher():IEventDispatcher
//	{
//		if (!application)
//		{
//			application = IEventDispatcher(FlexGlobals.topLevelApplication);
...
//	}
	...
	private var _topLevelDispatcher:IEventDispatcher;
	 ...
	 */
	private function get popupDispatcher():IEventDispatcher
	{
		if (_topLevelDispatcher == null)
		{
			_topLevelDispatcher = SystemManagerGlobals.topLevelSystemManagers[0];
		}
		return _topLevelDispatcher;
	}
