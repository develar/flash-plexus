...
package com.asfusion.mate.events
{
	...
	public class Dispatcher implements ILoggerProvider, IMXMLObject
	{
		...
		*/
		...
		//.........................................responseHandlers..........................................
		private var _responseHandlers:Vector.<IResponseHandler> = new Vector.<IResponseHandler>();
		/**
		 * Array <code>IResponseListeners</code> that are interested in listening to responses
		 * after the event is dispatched.
		 */
		public function get responseHandlers():Vector.<IResponseHandler>
		{
			return _responseHandlers;
		}
		public function set responseHandlers(value:Vector.<IResponseHandler>):void
		{
		...
		public function generateEvent(inlineProperties:Object = null):Boolean
		{
			...
			if(constructorArguments !== undefined)
			{
				...
				instance = MateManager.instance.instantiator.create(generator, null, false, realParams);
			}
			else
			{
				if(type)
				{
					instance= MateManager.instance.instantiator.create(generator, null, false, [type, bubbles, cancelable], Cache.NONE);
				}
				else
				{
		...
		*/
		...
		{
			return "EventType:"+ type + ". Error was found in a Dispatcher in file "
